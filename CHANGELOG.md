...
- Updated desktop beta download links to the `CoreKnot Beta` GitHub release assets.
...
[1.0.8-beta.3]: https://github.com/theshakticollective/coreknot/releases/tag/v1.0.8-beta.3
