...
```
Frontend uploads to: https://YOUR-RENDER-SERVICE.onrender.com/api/upload/profile-picture
Image URL returned: /uploads/timestamp-username.webp
Frontend displays: https://YOUR-RENDER-SERVICE.onrender.com/uploads/timestamp-username.webp
```
