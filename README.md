...
| **Campaign audience (Jun 2026)** | Dedicated **Exly** source tile + `GET /api/mail/audience/exly`; CRM status/offering/category filters; Select all / Deselect all; Exly rows ship as `customRecipients` |
