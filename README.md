...
| **Campaign geo & mail studio** | Option C WYSIWYG block spacing (`shared/emailBlockSpacing.cjs`); campaign detail geo charts; click geo filters datacenter/scanner IPs; rebuild one campaign: `node server/scripts/rebuildCampaignLocationBreakdown.js <id> [--dry-run]` |
