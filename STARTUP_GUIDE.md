...
**Production (Vercel frontend + Render API):** set `VITE_API_URL=https://taskmaster-api.onrender.com` on the static host. Set `APP_BASE_URL` to the same API URL on Render for email open/click tracking.
