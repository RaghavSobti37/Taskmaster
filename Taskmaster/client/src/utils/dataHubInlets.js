...
export const INLET_META = {
  ...
  academy_students: { key: 'academy_students', label: 'Academy Students', icon: 'GraduationCap' },
  havells_registered: { key: 'havells_registered', label: 'Havells Participants', icon: 'Users' },
  havells_selected: { key: 'havells_selected', label: 'Havells Selected', icon: 'CheckCircle' },
  havells_attended_delhi: { key: 'havells_attended_delhi', label: 'Havells Attended Delhi', icon: 'MapPin' },
  havells_attended_indore: { key: 'havells_attended_indore', label: 'Havells Attended Indore', icon: 'MapPin' },
  havells_attended_dumka: { key: 'havells_attended_dumka', label: 'Havells Attended Dumka', icon: 'MapPin' },
