  ...
  try {
    ...
    setImmediate(async () => {
      try {
        ...
        // Run the local in-memory location lookup (Gmail proxy IP Γëá reader city ΓÇö skip geo on opens)
...
// Legacy GET /unsubscribe on API host ΓåÆ frontend page (old emails pointed at API /unsubscribe)
