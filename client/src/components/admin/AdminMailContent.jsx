...
<div>
  ...
  <div style="font-size: 18px; font-weight: bold; color: #C15717; margin-top: 10px;">Raghav Raj Sobti</div>
  ...
  <div style="font-size: 13px; margin-top: 10px;">
    ...
    <strong>E:</strong> <a href="mailto:raghavsobti37@gmail.com" style="color: #222222; text-decoration: underline;">raghavsobti37@gmail.com</a> | 
...
export default function AdminMailContent({ initialMode = null, hideModeBar = false } = {}) {
  ...
  const [testCampaignEmail, setTestCampaignEmail] = useState('raghavsobti37@gmail.com');
