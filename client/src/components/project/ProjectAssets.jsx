      ...
      <AnimatePresence>
        {showAddModal && (
          <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
            <motion.div initial={{ scale: 0.95, y: 20 }} animate={{ scale: 1, y: 0 }} exit={{ scale: 0.95, y: 20 }} className="bg-[var(--color-bg-surface)] border border-[var(--color-bg-border)] w-full max-w-md rounded-[2.5rem] shadow-2xl overflow-hidden p-8">
