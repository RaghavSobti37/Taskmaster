...
const OTPVerificationPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-slate-900 dark:to-slate-800 text-foreground relative overflow-hidden flex items-center justify-center p-6">
      {/* Animated background */}
      ...
      <motion.div
        ...
        className="relative z-10 w-full max-w-md bg-white dark:bg-slate-800 p-8 rounded-3xl border border-gray-200 dark:border-slate-700 shadow-xl backdrop-blur-xl"
      >
        {/* Header */}
