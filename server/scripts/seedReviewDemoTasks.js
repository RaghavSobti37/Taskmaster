...
const DEMO_SPECS = [
  { title: 'Finalize slide deck', projectName: /sandesh/i, assigneeEmail: 'aryaman@theshakticollective.in' },
  { title: 'Export social cuts', projectName: /instagram/i, assigneeEmail: 'atharva@theshakticollective.in' },
  { title: 'Color grade episode 2', projectName: /luca/i, assigneeEmail: 'rohith@theshakticollective.in' },
  { title: 'Mix master audio', projectName: /havelis|havells/i, assigneeEmail: 'aryaman@theshakticollective.in' },
...
async function main() {
  ...
  const reviewer = await User.findOne({ email: 'harshika@theshakticollective.in' })
    || await User.findOne({ email: 'raghavraj@theshakticollective.in' });
