...
const seed = async () => {
  try {
    ...
    // Create Dummy Users
    const users = [
      { name: 'Harshika', email: 'redacted-staff@example.com', role: 'user', teams: ['SOCIAL MEDIA', 'PR'] },
      { name: 'Rohith', email: 'redacted-staff@example.com', role: 'user', teams: ['EDITING', 'SHOOT'] },
      { name: 'Raghav Raj', email: 'REDACTED_ADMIN@example.com', role: 'admin', teams: ['TECH', 'SALES'] },
