...
async function run() {
  ...
  const campaign = await MailCampaign.create({
    ...
    content: '<p>Hello Raghav Raj Sobti,</p><p>This is a test of the fully functional campaign builder including rich text, attachments, and HolySheet logic.</p><br/><br/><div dir="ltr"><strong>The Shakti Collective</strong></div>',
    senderProfileId: profile._id,
    recipients: [{ name: 'Raghav Raj Sobti', email: 'raghavsobti37@gmail.com' }],
    status: 'Draft',
    createdBy: admin._id,
    attachments: [
      {
