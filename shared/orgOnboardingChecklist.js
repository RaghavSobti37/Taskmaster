/** Org dashboard onboarding checklist — keep in sync with orgOnboardingChecklist.cjs */

export const SOLO_TEAM_SIZE_VALUES = new Set(['1', 'just-me', 'solo', 'only-me']);

export const BASE_ONBOARDING_CHECKLIST_STEPS = [
  {
    id: 'profile_complete',
...
export const ENTERPRISE_ONBOARDING_CHECKLIST_STEPS = [
  {
    id: 'configure_sso',
    label: 'Configure SSO',
...
export function getApplicableOnboardingSteps(tenant) {
...
export const CHECKLIST_SNOOZE_MS = 24 * 60 * 60 * 1000;

export const ONBOARDING_CHECKLIST_STEPS = BASE_ONBOARDING_CHECKLIST_STEPS.map(({ id, label, path, why }) => ({
  id,
  label,
  path,
  why,
