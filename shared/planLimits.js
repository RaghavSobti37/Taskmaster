...
const PLAN_LIMITS = {
  ...
  pro: {
    ...
    storageMb: 10240,
    features: ['resend', 'google', 'meta', 'knowledgeEngine', 'finance', 'artistOs'],
    enterpriseOnly: ['sso', 'scim', 'customRoles', 'auditExport', 'apiKeys', 'webhooks', 'ipAllowlist'],
  },
  enterprise: {
    seats: 500,
    ...
    storageMb: 102400,
    features: ['resend', 'google', 'meta', 'knowledgeEngine', 'finance', 'artistOs', 'sso', 'scim', 'customRoles', 'auditExport', 'apiKeys', 'webhooks', 'ipAllowlist'],
    enterpriseOnly: [],
  },
};
